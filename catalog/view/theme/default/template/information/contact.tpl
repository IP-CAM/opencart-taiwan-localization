        ...
        <div class="panel-body">
          <div class="row">
            ...
            <div class="col-sm-3"><strong><?php echo $store; ?></strong><br />
              ...
              <?php if ($geocode) { ?>
              <a href="https://maps.google.com.tw/maps?q=<?php echo urlencode($geocode); ?>&hl=zh-TW" target="_blank" class="btn btn-info"><i class="fa fa-map-marker"></i> <?php echo $button_map; ?></a>
              <?php } ?>
            </div>
