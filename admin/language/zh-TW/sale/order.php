...
$_['text_date_added']         = '產生日期：';
$_['text_date_modified']      = '修改日期：';
$_['text_firstname']          = '用戶的名字：';
$_['text_lastname']           = '用戶的姓氏：';
$_['text_company']            = '公司名稱：';
...
$_['help_ip_city_confidence']                 = '這個縣市的位置是正確的。';
$_['help_ip_postal_confidence']               = '這個郵遞區號的位置是正確的。';
$_['help_ip_postal_code']                     = '估計IP地址的郵遞區號。';
$_['help_ip_accuracy_radius']                 = '以英里計算最終用戶的實際位置和GeoIP的的縣市數據庫的IP地址的平均距離。';
...
$_['error_password']          = '密碼長度必須在3到20個字之間！';
