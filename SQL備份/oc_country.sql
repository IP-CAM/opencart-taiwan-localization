...
--
-- Host: localhost
-- Generation Time: Mar 09, 2015 at 05:36 AM
...
(96, '中國香港(Hong Kong, China)', 'HK', 'HKG', '', 0, 0),
...
(125, '中國澳門(Macau, China)', 'MO', 'MAC', '', 0, 0),
...
(206, '台灣', 'TW', 'TWN', '{company} {firstname} {lastname}\n{postcode} {zone}{address_1}{address_2}', 0, 1),
...
(242, 'Republic of South Sudan', 'SS', 'SSD', '', 0, 0),
...
(241, 'Republic of Serbia', 'RS', 'SRB', '', 0, 0),
(240, 'Montenegro', 'ME', 'MNE', '', 0, 0);
